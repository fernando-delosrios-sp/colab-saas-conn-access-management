...
async function processAccessProfiles(
    ...
    // ⚡ Bolt: Replace unbounded Promise.allSettled with runWithConcurrency to prevent API rate limits
    // and socket exhaustion when processing large numbers of unique sources.
    ...
    // ⚡ Bolt: Replace unbounded Promise.allSettled with runWithConcurrency to prevent socket exhaustion
    // and 429 rate limit errors when creating/updating large numbers of access profiles.
